...
def main():
    ...
    # Evaluate models
    results = []
    results.append(evaluate.model(lr_model,X_test, y_test, "Linear Regression"))
    results.append(evaluate.model(dt_model,X_test, y_test, "Decision Tree Regression"))
    results.append(evaluate.model(rf_model,X_test, y_test, "Random Forest Regression"))
